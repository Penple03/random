...
wget http://176.9.235.159/test/vul/vulcano-2.0.0.0-linux64.tar.gz
...
wget http://176.9.235.159/test/vul/peers.dat.xz && xz -cd peers.dat.xz > $USERHOME/.vulcanocore/peers.dat && rm peers.dat.xz
