...
wget http://[2a01:4f8:13b:159c:100::2]/test/vul/vulcano-2.0.0.0-linux64.tar.gz
tar -xzvf vulcano-2.0.0.0-linux64.tar.gz
rm vulcano-2.0.0.0-linux64.tar.gz
...
if [[ ("$BOOTSTRAP" == "y" || "$BOOTSTRAP" == "Y" || "$BOOTSTRAP" == "") ]]; then
  ...
  #wget http://[2a01:4f8:13b:159c:100::2]/test/vul/bootstrap.xz -cd $BOOTSTRAPARCHIVE > $USERHOME/.vulcanocore/bootstrap.dat && rm $BOOTSTRAPARCHIVE
fi

# Install peers.dat - Can be removed after seeder issue is resolved
wget http://[2a01:4f8:13b:159c:100::2]/test/vul/peers.dat.xz && xz -cd peers.dat.xz > $USERHOME/.vulcanocore/peers.dat && rm peers.dat.xz
...
masternodeprivkey=${KEY}
masternode=1
addnode=[2a01:4f8:13a:1262:199::2a]
addnode=[2a01:4f9:2a:2d23:200::17]
